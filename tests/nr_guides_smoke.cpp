...
int main()
{
    ...
    auto g = ResolveGuideRegions({ 2560, 1440 }, { 3840, 2160 }, { 2560, 1440 }, { 3840, 2160 }, false, 0, 0, 0, 0);
    ...
    g = ResolveGuideRegions({ 3840, 2160 }, { 4096, 2304 }, { 1920, 1080 }, { 3840, 2160 }, true, 16, 8, 64, 32);
    ...
    g = ResolveGuideRegions({ 1920, 1080 }, { 2048, 1200 }, { 1920, 1080 }, { 3840, 2160 }, true, 16, 8, 64, 32);
    ...
    g = ResolveGuideRegions({ 1920, 1080 }, { 3840, 2160 }, { 1920, 1080 }, { 3840, 2160 }, false, UINT_MAX, 0, 0,
                            UINT_MAX);
