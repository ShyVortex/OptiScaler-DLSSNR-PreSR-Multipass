...
try
{
    ...
    {
        param->Set(NVSDK_NGX_Parameter_Width, w);
        param->Set(NVSDK_NGX_Parameter_Height, h);
        param->Set(NVSDK_NGX_Parameter_OutWidth, ow);
        param->Set(NVSDK_NGX_Parameter_OutHeight, oh);
        param->Set(NVSDK_NGX_Parameter_CreationNodeMask, 1u);
        param->Set(NVSDK_NGX_Parameter_VisibilityNodeMask, 1u);
    ...
    ngx(create(commands.Get(), NVSDK_NGX_Feature_SuperSampling, p, &feature));
    submit();
    ngx(create(commands.Get(), NVSDK_NGX_Feature_SuperSampling, p2, &other));
    submit();
    expect(feature != other, "DLSS reused a feature handle instead of independent histories");
    p->Set(NVSDK_NGX_Parameter_Color, carrier.Get());
    p->Set(NVSDK_NGX_Parameter_Output, output.Get());
    p->Set(NVSDK_NGX_Parameter_Depth, depth.Get());
    p->Set(NVSDK_NGX_Parameter_MotionVectors, motion.Get());
    p->Set(NVSDK_NGX_Parameter_ExposureTexture, exposure.Get());
    p->Set(NVSDK_NGX_Parameter_DLSS_Render_Subrect_Dimensions_Width, w);
    p->Set(NVSDK_NGX_Parameter_DLSS_Render_Subrect_Dimensions_Height, h);
    p->Set(NVSDK_NGX_Parameter_Jitter_Offset_X, 0.0f);
    p->Set(NVSDK_NGX_Parameter_Jitter_Offset_Y, 0.0f);
    p->Set(NVSDK_NGX_Parameter_MV_Scale_X, 1.0f);
    p->Set(NVSDK_NGX_Parameter_MV_Scale_Y, 1.0f);
    p->Set(NVSDK_NGX_Parameter_DLSS_Pre_Exposure, 1.0f);
    p->Set(NVSDK_NGX_Parameter_DLSS_Exposure_Scale, 1.0f);
    p->Set(NVSDK_NGX_Parameter_FrameTimeDeltaInMsec, 16.67f);
